    ...
    <div class="a-merg__items-list">
        ...
        <div class="a-merg__item">
            ...
            <div class="a-merg__item__content">
                ...
                <span class="a-merg__item__infos">#2137 opened 2 days ago by jd</span>
            </div>
        </div>
        <!-- item ------------------------------------->
        <div class="a-merg__item">
            ...
            <div class="a-merg__item__content">
                ...
                <span class="a-merg__item__infos">#2155 opened 2 hours ago by sileht</span>
            </div>
        </div>
        <!-- item ------------------------------------->
        <div class="a-merg__item">
        ...
        <div class="a-merg__item">
            ...
            <div class="a-merg__item__content">
                ...
                <span class="a-merg__item__tag a-merg__item__tag--bug">bug</span>
                <span class="a-merg__item__infos">#2142 opened 1 week ago by Yves</span>
            </div>
        </div>
        <!-- item ------------------------------------->
